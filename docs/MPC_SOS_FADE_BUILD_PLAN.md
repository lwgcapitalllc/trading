...
**Goal:** port the MPC SOS Fade strategy (`strategies/tradingview/mpc_strategy.pine`) to a Python bot, backtest it
...
tests). **Parity harness BUILT 2026-07-15** — `strategies/tradingview/mpc_strategy_export.pine` (strategy +
