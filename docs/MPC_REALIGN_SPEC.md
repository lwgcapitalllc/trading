...
**Inherited from `strategies/python/mpc_sos_fade/CLAUDE.md` → *The exit ladder*, with the stop
overridden.** This is the `mpc_bleg` pattern: that fork replaces TP1, TP2 and the SL with its own
...
`strategies/python/mpc_realign/`, 467,352 M5 bars (2020-01-02 → 2026-08-06), full A+ exit
...
This is the same lesson `mpc_d_strategy.pine` recorded on 2026-08-06, met again five days later.
...
| # | Stage | Artefact |
|---|---|---|
| 2 | Pine strategy | `strategies/tradingview/mpc_realign_strategy.pine` |
| 3 | Pine export twin | `strategies/tradingview/mpc_realign_strategy_export.pine` |
