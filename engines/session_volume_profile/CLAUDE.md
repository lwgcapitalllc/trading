...
Pine source of truth: `indicators/mpc_assistant.pine` — SVP block (2554-2659), MV slot (2772-2786).
Parity export build: `indicators/svp_export.pine`.
...
- Pine source of truth: `indicators/mpc_assistant.pine` (SVP 2554-2659, MV slot 2772-2786).
- Parity export build: `indicators/svp_export.pine`.
