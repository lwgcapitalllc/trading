...
def test_history_fifo_keeps_last_two():
    ...
    def session(day, hi, lo):
        nonlocal idx
        out = []
        out.append((idx, ums(2024, 7, day, 12), 100, 100, 100, 100, 0)); idx += 1       # out prime
        out.append((idx, ums(2024, 7, day + 1, 0), 100, hi, lo, 100, 10)); idx += 1      # open
        out.append((idx, ums(2024, 7, day + 1, 3), 100, (hi + lo) / 2 + 1, (hi + lo) / 2 - 1, 100, 100)); idx += 1
        out.append((idx, ums(2024, 7, day + 1, 9), 100, 100, 100, 100, 0)); idx += 1     # close
        return out
