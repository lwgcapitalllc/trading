...
SAMPLE = [
    ...
    {"title": "No Date Row", "country": "US", "currency": "USD", "date": None, "importance": 0},
]
...
def test_null_values_become_none():
    speech = next(
        e for e in TradingViewSource.parse_result(SAMPLE) if e.title == "Fed Chair Speech"
    )
