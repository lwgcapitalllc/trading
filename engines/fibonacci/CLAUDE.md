...
**Last reviewed:** 2026-07-31 — ⚠ **THE MACRO (CYCLE) FIB IS NOW A FORK: the two Pine files disagree, and this engine deliberately follows the STRATEGY one.** `/audit-engines` found `mpc_assistant.pine` reworked its Cycle fib on 2026-07-31 in two independent ways, each of which moves every price on the ladder:
