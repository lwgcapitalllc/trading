...
⚠ The trading-day rollover has NO Pine counterpart — the chart reads the exchange's own daily bars — so it is typed once but checked only by the parity gate.
