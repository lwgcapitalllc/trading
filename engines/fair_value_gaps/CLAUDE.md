...
- Consumers, and they run DIFFERENT settings on purpose (see the `require_close` callout above):
  - `strategies/python/sos_fade/` — the A+ setup reads live gaps overlapping the fib entry zone
