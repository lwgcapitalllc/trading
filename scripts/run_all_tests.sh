...
echo "  [1/14] engines / backtest / algos / strategies / smart-money ..."
...
echo "  [2/14] command-center backend ..."
...
echo "  [6/14] documentation-size guard ..."
...
echo "  [8/14] trade-overlay geometry ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [9/14] parameter-condition evaluator ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [10/14] period-window rebase ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [11/14] instrument search + recents ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [12/14] theme colour tokens ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [13/14] git-hook bypass guard ..."
...
echo "  [14/14] pine block drift (copies vs the indicator) ..."
