...
echo "  [1/15] engines / backtest / algos / strategies / smart-money ..."
...
echo "  [2/15] command-center backend ..."
...
echo "  [6/15] documentation-size guard ..."
...
echo "  [8/15] trade-overlay geometry ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [9/15] parameter-condition evaluator ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [10/15] period-window rebase ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [11/15] instrument search + recents ..."
if [ -d "command-center/frontend/node_modules" ]; then
...
echo "  [12/15] theme colour tokens ..."
if [ -d "command-center/frontend/node_modules" ]; then
