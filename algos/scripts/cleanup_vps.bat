...
del "C:\trading\algos\markets\fx\instances\gold_scalper\scalper_equity.json" 2>nul
del "C:\trading\algos\markets\fx\instances\gold_fft\fft_equity.json" 2>nul

REM Old weekly files (replaced by weekly fields in bot_state.json)
del "C:\trading\algos\markets\fx\instances\gold_main\smc_trend_weekly.json" 2>nul
del "C:\trading\algos\markets\fx\instances\gold_main\mean_reversion_weekly.json" 2>nul
del "C:\trading\algos\markets\fx\instances\gold_scalper\scalper_weekly.json" 2>nul
del "C:\trading\algos\markets\fx\instances\gold_fft\fft_weekly.json" 2>nul
...
del "C:\trading\algos\markets\fx\instances\gold_scalper\startup_time.json" 2>nul
del "C:\trading\algos\markets\fx\instances\gold_fft\startup_time.json" 2>nul

REM Truncate stdout logs (keep files but clear old content)
echo. > "C:\trading\algos\markets\fx\instances\gold_main\smc_trend_stdout.log"
echo. > "C:\trading\algos\markets\fx\instances\gold_main\mean_reversion_stdout.log"
echo. > "C:\trading\algos\markets\fx\instances\gold_scalper\scalper_stdout.log"
echo. > "C:\trading\algos\markets\fx\instances\gold_fft\fft_stdout.log"
