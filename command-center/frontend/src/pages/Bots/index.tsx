    ...
    return (
      ...
      >
        <button
          ...
          className="w-full flex items-center flex-wrap gap-y-2 gap-x-3 px-4 py-[13px] text-left hover:bg-bg-surface-2 transition-colors"
        >
            ...
            <span className="w-[118px] flex flex-col items-end justify-center gap-[3px] pl-[14px]">
              ...
              >
                ...
                {balance == null && asking ? (
                  ...
                  // The same dash its three neighbours hold when they have nothing to state.
                  ...
                  // A bot IS on this account but none is reading it live — a stopped bot's last
                  // reading, or the newest one any bot took here. Nothing else on the card says
                  // this figure is old, so the time stays on screen, not just on hover.
                  <span
