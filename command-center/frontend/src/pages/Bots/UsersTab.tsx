...
export function UsersTab() {
  ...
  return (
    <div>
      ...
      {isLoading && (
        <div className="text-small text-text-tertiary py-6 text-center">Loading users from VPS…</div>
      )}
      {error && (
      ...
      <div className="bg-bg-surface border border-border-subtle rounded-lg p-4">
        <div className="text-[12px] font-semibold mb-3 text-text-secondary uppercase tracking-[0.5px]">Add user</div>
        <div className="flex items-start gap-2 flex-wrap">
          <div className="flex flex-col gap-1">
            <label className="text-[10px] text-text-tertiary uppercase tracking-[0.5px]">Chat ID</label>
            <input
              type="text"
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[10px] text-text-tertiary uppercase tracking-[0.5px]">Name</label>
            <input
              type="text"
              placeholder="Aaron"
              value={form.name}
          ...
          <div className="flex flex-col gap-1">
            <label className="text-[10px] text-text-tertiary uppercase tracking-[0.5px]">Role</label>
            <select
              value={form.role}
        ...
        {formError && (
          <p className="text-[11px] text-neg-text mt-2">{formError}</p>
        )}
        <p className="text-[10px] text-text-tertiary mt-3">
          Tip: ask users to message <span className="font-mono">@userinfobot</span> on Telegram to get their chat ID.
        </p>
      </div>
