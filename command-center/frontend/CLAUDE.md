...
## Dragging a bot between accounts — a second GESTURE, never a second path (2026-08-12)

A bot's row on the Accounts tab is draggable and an account card is a drop target. Aaron's words:
*"if I wanna switch a bot between accounts, I could, like, drag and drop bot from one account to
the next and hit, like, a deploy button."*
