...
**Last reviewed:** 2026-07-28 — the price chart got a Go-to-date jump (type a date, it pages the history in and lands there); 2026-07-27 — missed setups (how close the ones that died came) shipped end to end alongside blocked setups; the price chart now opens on the timeframe the run traded
