...
bearish candles in the drawdown zone"*). The layer draws the engine's fifteen named RULES, and
✅ **measured on that trade (2026-06-18 short): its retrace zone is 9 bars and exactly ONE carries a
pattern** — against the 2026-06-16 short's 21 bars carrying 8. Nothing is being withheld; the other
eight bars have no pattern on them.
