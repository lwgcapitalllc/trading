...
⚠ **A 3/3 MISS passes NO entry price and keeps the turn-relative window**: no position was opened,
so it has no drawdown, and its span is already the visit into the zone.
