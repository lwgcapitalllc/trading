...
const CASES = [
  ...
  [REFUSE, 'POST', '/api/bots/mpc_sos_fade_demo/stop', 'stop the armed bot'],
  [REFUSE, 'POST', '/api/bots/mpc_sos_fade_demo/start', 'start one bot'],
  [REFUSE, 'POST', '/api/bots/mpc_bleg_demo/restart', 'restart one bot'],
  [REFUSE, 'POST', 'http://localhost:8000/bots/mpc_sos_fade_demo/stop', 'absolute URL'],
  [REFUSE, 'post', '/api/bots/mpc_sos_fade_demo/stop', 'lowercase method'],
  [REFUSE, 'POST', '/api/bots/mpc_sos_fade_demo/stop?force=1', 'query string ignored'],
  [REFUSE, 'POST', '/api/bots/mpc_sos_fade_demo/stop/', 'trailing slash'],

  // --- promote and deploy ---
  [REFUSE, 'POST', '/api/bots/mpc_sos_fade_demo/promote', 'promote'],
  ...
  [ALLOW, 'GET', '/api/bots/mpc_sos_fade_demo/stop', 'a GET is not the stop action'],
  ...
  [ALLOW, 'POST', '/api/bots/mpc_sos_fade_demo/promote/preview', 'promote PREVIEW changes nothing'],
  ...
  [ALLOW, 'POST', '/api/bots/mpc_sos_fade_demo/promote/history', 'not the promote action'],
