...
│   └── svp/             ← Session Volume Profile engine (Asia POC / MV line + sweep); consumes sessions/, needs volume
...
13. `engines/svp/CLAUDE.md` — Session Volume Profile engine (Asia POC / MV line), parity rules
...
| `engines/svp/` | Session Volume Profile engine (Asia POC / MV line + sweep) | Production — 100% Pine parity (VANTAGE_XAUUSD 5m) | `engines/svp/CLAUDE.md` |
