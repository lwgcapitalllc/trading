...
`strategies/tradingview/CLAUDE.md` -> the tied-extreme fix). Running this script regenerates the
...
Usage:  python3 strategies/tradingview/tools/derive_htf_structure.py
"""
...
# see `strategies/tradingview/CLAUDE.md` -> Section 2 is FIXED.
...
def derive(text: str) -> str:
    ...
    header = (
        ...
        "// Generated by strategies/tradingview/tools/derive_htf_structure.py from\n"
