# h4_sweep_strategy.pine — commentary
...
**Covers:** `h4_sweep_strategy.pine`, `h4_sweep_strategy_export.pine`

---

## [1] H4 SWEEP — liquidity sweep → candlestick confirmation → LTF close en

```
// ============================================================================
//  H4 SWEEP — liquidity sweep → candlestick confirmation → LTF close entry
// ============================================================================
...
// mpc_jarvis.pine. This exists to answer one question — does the sequence produce
...
// Nothing in this repo detects a Harami or an Engulfing. Not mpc_jarvis.pine, not
...
// ════════════════════════════════════════════════════════════════════════════
// Lifted BYTE-FOR-BYTE from the since-deleted strategies/tradingview/d_strategy.pine
// (removed 2026-08-15 — recover from git history), which lifted it from
// indicators/engines/structure_engine.pine, itself the external+internal half of mpc_jarvis.pine.
...
## [14] MARKET STRUCTURE — input selection (mirrors mpc_jarvis.pine's GRP_STR

```
//============================================================
//  MARKET STRUCTURE — input selection (mirrors mpc_jarvis.pine's GRP_STRUCT)
//============================================================
```
...
// close. Same split mpc_jarvis.pine uses for its H4 tracker.
```
...
// the liquidity was taken, not whether it was taken. Same reading mpc_jarvis.pine
...
// NOTHING in this file reads these four. They exist so `h4_sweep_strategy_export.pine`
...
## [38] ⚠ THE SIDE HAS TO BE RECORDED RATHER THAN INFERRED, and the deleted `d_strategy.

```
// ⚠ THE SIDE HAS TO BE RECORDED RATHER THAN INFERRED, and the deleted `d_strategy.pine` already paid for
...
// ════════════════════════════════════════════════════════════════════════════
// This file is `h4_sweep_strategy.pine` + THIS appended block, and NOTHING else
...
//     cp strategies/tradingview/h4_sweep_strategy.pine <export>
//     sed -i '' '166s/strategy("H4 Sweep"/strategy("H4 Sweep Export"/' <export>
//     cat /tmp/blk >> <export>
...
// the final stage on the close bar. ⚠ The deleted `d_strategy_export.pine` tracked its own copy because
...
## [51] ── Bar classification ──────────────────────────────────────────────────  _(only in h4_sweep_strategy_export.pine)_
...
## [52] ════════════════════════════════════════════════════════════════════════  _(only in h4_sweep_strategy_export.pine)_
...
## [53] ════════════════════════════════════════════════════════════════════════  _(only in h4_sweep_strategy_export.pine)_
...
## [54] The fifteen pattern toggles, packed in the order they are declared. Kept  _(only in h4_sweep_strategy_export.pine)_
