# mpc_realign_strategy.pine — commentary
...
**Covers:** `mpc_realign_strategy.pine`

---

## [1] MPC REALIGN — internal-structure realignment after an external false bre
...
//   comparable. Measure it in Python first. Tables: strategies/python/mpc_realign/CLAUDE.md
```
