...
└── tradingview/    ← Pine v6 `strategy()` source — TradingView Strategy Tester only
    ...
    ├── realign_strategy.pine (+ its export twin since 2026-09-16), recovery_strategy.pine
