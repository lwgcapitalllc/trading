...
**Last reviewed:** 2026-07-26 — both Python bots gained the Pine's new exit levers (structure runner trail, TP2 stop floor), and the B-LEG got its Pine-parity harness; the switchable TP/SL register lives in `python/mpc_sos_fade/CLAUDE.md` → `## The exit ladder`
