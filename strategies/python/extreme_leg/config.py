"""ExtremeLegConfig — every input on `extreme_leg_strategy.pine`, as a dataclass.
...
class ExtremeLegConfig:
    ...
    # nothing anywhere to say so. They are now keyword arguments on `ExtremeLegStrategy`, which
