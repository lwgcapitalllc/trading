...
Every figure in this file and in `strategies/tradingview/docs/mpc_extreme_leg_strategy.md` stands.
...
`strategies/tradingview/mpc_extreme_leg_strategy_export.pine` on a XAUUSD **5-minute** chart, scrolls
...
`strategies/tradingview/docs/mpc_extreme_leg_strategy.md` quotes 24 trades at +0.060R each and a
