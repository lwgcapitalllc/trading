"""MpcExtremeLegStrategy — the run INTO the shift of structure.
...
class MpcExtremeLegStrategy:
    ...
    # ── drivers ──────────────────────────────────────────────────────────────
    def run(self, df, engine_config=None, warmup: int = 0) -> "MpcExtremeLegStrategy":
