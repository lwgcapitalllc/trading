...
⚠ **STILL NO ESTABLISHED EDGE, but the defaults MOVED on 2026-08-06 and the old numbers no longer
describe this bot.** The shipped configuration is now **112 trades / +12.02R / PF 1.23 / maxDD
−8.89R over 7.9 years with spread and swap charged** (free book: +17.64R / PF 1.36 / maxDD −6.21R),
against the pre-change **59 / −1.73R / PF 0.94 / maxDD −16.00R** on the same bars and the same
charges. Both halves of the history are positive now where the old defaults lost 8R in the first.
**The 95% CI on mean R is −0.140 → +0.355 and still contains zero**, so read this as "the
measurement moved up and narrowed", never as "it works". See "The exit-ladder re-default".
