...
the same fix is in `strategies/tradingview/mpc_strategy.pine` AND `strategies/tradingview/mpc_strategy_export.pine`,
...
| `strategies/tradingview/mpc_strategy.pine` | 4546 (`if lStage < 1 and high >= lTP1`) |
