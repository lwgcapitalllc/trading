...
`strategies/python/mpc_sos_fade/CLAUDE.md` → *The two price refusals report themselves*.
...
from strategies.python.mpc_sos_fade.config import SosFadeConfig  # noqa: E402
...
def test_the_message_the_reader_actually_receives_names_both_rules():
    ...
    snap = SetupSnapshot(key="k", strategy="MpcSosFadeStrategy", symbol="XAUUSD.p", side=1,
                         state=WATCHING,
