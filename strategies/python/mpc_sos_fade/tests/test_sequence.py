...
from mpc_sos_fade import SignalAdapter, SosFadeConfig, SosFadeSequence  # noqa: E402
...
def _sig(**kw):
    ...
    base = dict(
        ...
        fibo_ash=None,
        fibo_asl=None,
        fibo_half_reached=False,
        fibo_618_ever_reached=False,
        fibo7_touched=False,
        fvgs=[],
        poi_long_now=False,
        poi_short_now=False,
...
def test_sweep_then_sos_advances_to_stage_2():
    ...
    st = seq.update(
        _sig(index=1, time_ms=60_000, bull_sos=True, recent_ssl="Asia Low", recent_ssl_bar=0)
    )
