...
Proves SosFadeStrategy.run() drives SignalAdapter -> SosFadeSequence -> Execution over
...
def test_engine_config_pins_every_input_the_pine_moved_off_its_default():
    ...
    `fvg_require_close` cost exactly that on 2026-07-26: `sos_fade_strategy.pine` HARDCODES the
    ...
    on an active EQH/EQL survives the FVG cap, `sos_fade_strategy.pine` has defaulted it ON since
    ...
    ec = SosFadeStrategy.engine_config()
