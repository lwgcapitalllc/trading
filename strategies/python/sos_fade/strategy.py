"""SosFadeStrategy — the top-level driver.
...
class SosFadeStrategy:
    def __init__(self, config: Optional[SosFadeConfig] = None,
        ...
        # which `Execution` cannot know: `b_leg` and `bos` share this execution layer, so
    ...
    def stack_config(self, engine_config=None):
        ...
        — `compare_strategy.py`, `b_leg` and the parity tests all call it off the class. This is
    ...
    def engine_config():
        ...
        **This pin was MISSING until 2026-07-31** — the bot happened to work only because
        ...
        in `sos_fade_strategy.pine` and has DEFAULTED ON there since 2026-08-03 (`b1b461b`).
    ...
    def finalize(self, df) -> "SosFadeStrategy":
    ...
    def run_dual(self, df15, df1m, engine_config=None, warmup: int = 0,
        ...
        fills/manages on real bars of the faster frame. Full design: docs/SOS_FADE_SECONDARY.md.
