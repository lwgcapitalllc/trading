...
thin SUBCLASS of `sos_fade.execution.Execution` that overrides only entry placement:
  ...
  * The B-LEG rests a limit at the frozen band's near (0.5) edge, with SL beyond the leg
    ...
    expansion extreme (`tgt`), TP3 = runner. Ports b_leg_strategy.pine 4429-4506.
...
from sos_fade.execution import Execution, TradeFib, _Pending  # noqa: E402
...
class BLegExecution(Execution):
    ...
    # `strategies/tradingview/b_leg_strategy.pine`, which drops the pink tags for the same reason.
