"""RealignStrategy — the top-level Realign driver.
...
It SUBCLASSES `SosFadeStrategy` for the fill-model plumbing and the engine pins, the
...
class RealignStrategy(SosFadeStrategy):
