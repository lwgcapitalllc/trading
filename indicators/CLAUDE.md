...
**Last reviewed:** 2026-08-04 — **THE JARVIS TABLE GAINED A GROUP COLUMN, THE EQ LEVELS CHANGED WHAT "TAKEN" MEANS, AND THE 1m STOPPED TRACKING A FINISHED SETUP.** Four Pine changes across `mpc_assistant.pine` and the A+ strategy pair, and the line between them is the one worth carrying: **detection is FORKED on purpose, appearance is SYNCED.**
