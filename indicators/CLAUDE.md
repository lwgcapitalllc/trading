...
**Last reviewed:** 2026-07-12 — the whole structure chain was re-synced to the `choch_lock` removal in `mpc_assistant.pine` and re-validated at 100% Pine parity. See the "2026-07-12 structure re-sync" note below.
